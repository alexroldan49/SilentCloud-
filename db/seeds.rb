...
captain_crunch = Artist.create(name: "Captain Crunch", image_url: "https://ibb.co/YQNSRfq")
codie = Artist.create(name: "Codie", image_url: "https://ibb.co/ynLz9c6")
...
p1 = Playlist.create(playlist_name: "My Playlist", visits: 50000, image_url: "https://ibb.co/Qkm6nnh" )
p2 = Playlist.create(playlist_name: "My Favorites",  visits: 80000, image_url: "https://ibb.co/Qkm6nnh")

#seeding songs

Song.create(title: "Yoda of coding", duration: "3:08", artist_id: shivang.id, playlist_id: p1.id )
Song.create(title: "may the force be with you", duration: "4:10", artist_id: shivang.id, playlist_id: p1.id)
...
Song.create(title: "Ones and zeros", duration: "1:00", artist_id: codie.id, playlist_id: p1.id)
